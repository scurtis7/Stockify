            ...
            return this.state.quotes.map((quote, index) => {
                ...
                return (
                    <tr key={index}>
                        ...
                        <td>{timezone}</td>
                        <td>{currency}</td>
                        <td><Button className="Search-button" classActiveName="Search-button-active" onClick={() => this.add(symbol)}>Add</Button></td>
                    </tr>
                );
            });
        }
        ...
        return (
            <div className="Search">
                <Container fluid>
                        ...
                        <Col>
                            <InputGroup size="sm">
                                <InputGroupAddon addonType="prepend">
                                    <InputGroupText className="Search-input-group-text">Stock Search</InputGroupText>
                                </InputGroupAddon>
                    ...
                    <Row>
                        <Col>
                            <Button className="Search-button" classActiveName="Search-button-active" onClick={this.search}>Search</Button>
                        </Col>
                    </Row>
                    <Row><br/></Row>
                    <Row>
